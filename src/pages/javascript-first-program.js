...
export default function JavaScriptVariables() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/javascript-control-structure"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/javascript-operator"; // Update with your actual URL
      ...
      <main className="max-w-[1440px] mx-auto flex gap-14 justify-between relative py-3 px-4">
        ...
        <div className="w-full relative ">
          ...
          <div className="space-y-3">
            ...
            Steps of hello World program in Javascript or First program in Javascript:
            </h5>
            <div class="text-[#9EB2D2]">
              <p>
              1, Firstly, use HTML code for creating js outside the structure<br/>
2, Use a script tag inside the head or a body <br/>
3, if you print anything so type <br/>
document.write("Hello World!"); <br/>
4, And after use close Script Tag
              </p>
            </div>
...
Q-Write a Hello World program in Javascript Example?</p>
                </div>
              </div>
            </div>
...
Q-Write the Basic Example of Javascript Program?</p>
                </div>
              </div>
            </div>
            <div className="bg-[#1f3040] rounded-b-xl">
