...
export default function PhpBreak() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/php-switch"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/php-if-else"; // Update with your actual URL
          ...
          <div className="space-y-3">
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  <p className="text-lg font-semibold text-[#01B6FF]">
                  Q-Write a program to Check maximum no between three no in Php?
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  <p className="text-lg font-semibold text-[#01B6FF]">
                  Q-Write a program to Check no is positive, negative, zero in Php?
                  </p>
                </div>
              </div>
            </div>
