...
int main()
{
  ...
  for (i = 1; i <= 10; i++)
  {
   if (i == 4)
   {
    cout << "no is 4 ";
    break;
    cout << "This is break"; // This line is never reached
   }
   cout << i << " complete \n";
  }
return 0;
...
export default function CppVariable() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "./cpp-continue"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/cpp-for-loop"; // Update with your actual URL
        ...
        <div className="w-full relative ">
          ...
          <div className="space-y-3">
            ...
            {/* <div class="text-[#9EB2D2]">
               ...
               <p>1, Break statement in c++ keyword is used to exit from loop and switch <br/>
2, When a break encounter inside any loop, control automatically passes to the first statement after the loop.<br/>
3, Break in C++ statement is used to terminate a loop immediately.<br/>
4, The break statement is encountered inside a loop</p>
            <h1 class="text-[#01B6FF] my-4 sm:text-2xl text-xl font-semibold sm:font-normal ">
            Break syntax in c++
              </h1>
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  ...
                  Q-write a program loop starts from 1 to 10 but stop or break when i=5 in break statement in c++?
                  </p>
                </div>
              </div>
            </div>
...
Q-Write a program loop starts from 1 to 10 but stop or break on first even no occur in break statement in c++?
                  </p>
                </div>
              </div>
            </div>
