        ...
        <div className="w-full relative ">
          ...
          <div className="space-y-3">
            ...
            <div className="text-[#9EB2D2]">
              <p>The ( cin {''>>''} ) function is commonly used to input the value. cin {"">>""} receives them from the keyboard.</p>
            </div>
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  ...
                  Q-Write a program to user get only input in c++ programming language example?
                  </p>
                </div>
              </div>
            </div>
...
Q-Write a program to user input in a c++ programming language example?
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="bg-[#2c3e4c] p-3 rounded-b-xl font-bold ">
              <p class="whitespace-pre-wrap ">enter first no 
24 
enter second no 
14 
enter third no 
...
Q-Write a program to calculate and print simple interest in c++ programming language example?
                  </p>
                </div>
              </div>
            </div>
...
enter the value of p 45 <br/>
enter the value of r 68 <br/>
enter the value of t 25 <br/>
...
Simple Intrest: 765
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  <p className="text-lg font-semibold text-[#01B6FF]">
                  Q-Write a program to find and print the area of the rectangle in a c++ programming language example?
                  </p>
                </div>
              </div>
            </div>
...
Area: 20
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  <p className="text-lg font-semibold text-[#01B6FF]">
                  Q-Write a program to find out the value of pi and print area of the circle in a c++ programming language example?
                  </p>
                </div>
              </div>
            </div>
...
Q-Write a program to 3 subject marks add all values, and multiply all the values in the C++ programming language example?
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="bg-[#2c3e4c] p-3 rounded-b-xl font-bold ">
              <p class="whitespace-pre-wrap ">
              enter a value of a45 <br/>
enter a value of b84 <br/>
enter a value of c75 <br/>
Addition: 204  <br/>
Multiple: 283500
