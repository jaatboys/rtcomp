...
export default function CppVariable() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/c-array"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/c-break"; // Update with your actual URL
          ...
          <div className="w-full relative ">
            ...
            <div className="space-y-3">
                ...
                <div className=" flex gap-2  sm:pl-7 items-center">
                  ...
                  <div className="mx-1">
                    <p className="text-lg font-semibold text-[#01B6FF]">
                      Q-Write a program loop from 1 to 10 but continue when i=4
                      in the continue statement in C?
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-[#2c3e4c] p-3 rounded-b-xl font-bold ">
                <p class="whitespace-pre-wrap ">1 2 3 5 6 7 8 9 10</p>
              </div>
              <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
                <div className=" flex gap-2  sm:pl-7 items-center">
                  <div className="sm:p-1.5  rounded-full bg-[#ff6056]"> </div>
                  ...
                  <div className="mx-1">
                    <p className="text-lg font-semibold text-[#01B6FF]">
                      Q-Write a program loop that starts from 1 to 10 but
                      continue when i=4 or 8 in the continue statement in C?
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-[#2c3e4c] p-3 rounded-b-xl font-bold ">
                <p class="whitespace-pre-wrap ">1 2 3 5 6 7 9 10</p>
              </div>
              <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
                <div className=" flex gap-2  sm:pl-7 items-center">
                  <div className="sm:p-1.5  rounded-full bg-[#ff6056]"> </div>
                  ...
                  <div className="mx-1">
                    <p className="text-lg font-semibold text-[#01B6FF]">
                      Q-Write a program loop from 1 to 10 but continue when even
                      no occur in the continue statement in C?
                    </p>
                  </div>
                </div>
              </div>
