...
`
const code4 =`
int i; // This declare a variable means i is a variable
i=4; // This assigns 4 to (i) means assigns value in Variable`
...
export default function CppVariable() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/cpp-first-program"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/cpp-keyword"; // Update with your actual URL
      ...
      <main className="max-w-[1440px] mx-auto flex gap-14 justify-between relative py-3 px-4">
        ...
        <div className="w-full relative ">
          ...
          <div className="space-y-3">
            <h5 className='text-[#01B6FF] mt-3 lg:text-xl'>Identifiers Statement in c++:</h5>
            <div className="text-[#9EB2D2]">
             <p>1, Identifier in c++ is a name given to a variable method.<br/>
...
5, You don’t use any keyword in the same manner means or Uppercase and lowercase are different Means.</p>
            </div>
            ...
            {/* <p class="whitespace-pre-wrap ">Ans-error ! Because undefined symbol i in show() function</p> */}
            <h1 class="text-[#01B6FF] my-4 sm:text-2xl text-xl font-semibold sm:font-normal ">
