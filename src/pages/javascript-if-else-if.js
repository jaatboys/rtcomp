...
export default function JavaScriptVariables() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/javascript-switch"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/javascript-if-else"; // Update with your actual URL
...
Q-Write a program to Check maximum no between three no in Javascript?
</p>
                </div>
              </div>
            </div>
    ...
    <div className="bg-[#2c3e4c]  p-3 rounded-xl">
              <div className="flex gap-2 pl-7 items-center">
                ...
                <div className="mx-1">
                  <p className="text-xs smm:text-lg text-[#01B6FF]"> 
                  Q-Write a program to Check no is Positive, Negative, Zero in Javascript If Else If?</p>
                </div>
              </div>
            </div>
            <div className="bg-[#1f3040] rounded-b-xl">
