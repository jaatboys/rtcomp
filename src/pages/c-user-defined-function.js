...
export default function CIdentifier() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/c-passing-argument"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/c-function"; // Update with your actual URL
        ...
        <div className="w-full relative ">
          ...
          <div className="space-y-3">
            <div className="text-[#9EB2D2]">
              <p>
                The program can define its function, and a process consists of
                the following.
              </p>
            </div>
                ...
                <div className=" flex gap-2 pl-7 items-center">
                  ...
                  <div className="mx-1">
                    <p className="text-xs smm:text-lg text-[#01B6FF]">
                      Q-Write a program print (hello function) by Calling using
                      a user defined function in the C programming?
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div class="bg-[#2c3e4c] p-3 rounded-b-xl font-bold ">
              <p class="whitespace-pre-wrap ">
                This is a function program <br />
                hello function <br />
                hello is a function <br />
              </p>
            </div>
                ...
                <div className=" flex gap-2 pl-7 items-center">
                  ...
                  <div className="mx-1">
                    <p className="text-xs smm:text-lg text-[#01B6FF]">
                      ...
                      program when a person goes from the USA to stay in the UK
                      and create a plane to travel to India?
                    </p>
                  </div>
                </div>
              </div>
