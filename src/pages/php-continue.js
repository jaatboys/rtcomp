...
export default function PhpBreak() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/php-goto"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/php-break"; // Update with your actual URL
        ...
        <div className="w-full relative ">
          ...
          <div className="space-y-3">
            <div className="text-[#9EB2D2]">
              <p>
              A Php continue usually associated with an if
              </p>
            </div>
            <h1 className="text-[#01B6FF] mt-3 text-xl flex flex-col">
            Syntax for continue in Php:
            </h1>
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  <p className="text-lg font-semibold text-[#01B6FF]">
                  Q-Write a program loop starts from 2 to 14 and continues on six examples in Php?
                  </p>
                </div>
              </div>
            </div>
...
14<br/> 
            ...
            <div className="bg-[#2c3e4c] sm:p-3 py-3  rounded-t-xl">
              <div className=" flex gap-2  sm:pl-7 items-center">
                ...
                <div className="mx-1">
                  <p className="text-lg font-semibold text-[#01B6FF]">
                  Q-Write a program loop starts from 1 to 10 and continue on Fourth No in Continue?
                  </p>
                </div>
              </div>
            </div>
...
Q-Write a Program loop starts from 1 to 10 and continues on 4 and 8 and Print String example in Php?
