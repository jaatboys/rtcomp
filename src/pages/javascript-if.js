...
export default function JavaScriptVariables() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/javascript-if-else"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/javascript-control-structure"; // Update with your actual URL
            ...
            <div className="bg-[#2c3e4c]  p-3 rounded-xl">
              <div className="flex gap-2 pl-7 items-center">
                ...
                <div className="mx-1">
                  ...
                  Q-Write a program to input a number and check this number is more than or equal to 100 If Statement in JavaScript?</p>
                </div>
              </div>
            </div>
            <div className="bg-[#1f3040] rounded-b-xl">
...
This no is greater than 100 
    ...
    If Statement in Javascript with multiple conditions and Check if else in javascript
    </p>
    <div className="bg-[#2c3e4c]  p-3 rounded-xl">
              <div className="flex gap-2 pl-7 items-center">
                <div className="p-1.5 rounded-full bg-[#ff6056]"> </div>
                ...
                <div className="mx-1">
                  <p className="text-xs smm:text-lg text-[#01B6FF]"> 
                  Q-Write a program to input a number and print greater no If Statement in Javascript?</p>
                </div>
              </div>
            </div>
            <div className="bg-[#1f3040] rounded-b-xl">
...
This 160208 no is Greater than 500 
    </p></div>
