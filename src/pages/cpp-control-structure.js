...
export default function CppVariable() {
  ...
  const handleNext = () => {
    ...
    const nextPageUrl = "/cpp-if"; // Update with your actual URL
  ...
  const handlePrevious = () => {
    ...
    // Replace this logic with your actual routing structure
    const previousPageUrl = "/cpp-operator"; // Update with your actual URL
          ...
          <div className="flex justify-between mt-3">
            ...
            <div class="space-y-3">
              <div class="text-[#9EB2D2]">
                <p>
                  <br />
                  The program executes according to requirements. The sequence
                  can be changed using the control structure statement. The
                  categories and keywords show below:
                </p>
              </div>
              ...
              <div class="text-[#9EB2D2]">
                <p class="font-bold">
                  The conditional statement is many types in C++: <br />
                  If-Condition <br />
                  If-else
                  <br />
                  If-else-if
